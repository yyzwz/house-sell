...
export default {
                        ...
                        return h("div", [
                            h(
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            this.passCustomerSellFx(params.row);
                                        }
                                    }
                                },
                                "同意"
                            ...
                            h(
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            this.notPassCustomerSell(params.row);
                                        }
                                    }
                                },
                                "驳回"
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCustomerSellList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
