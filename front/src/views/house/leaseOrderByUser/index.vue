        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="houseOwner">
                        <Input type="text" v-model="searchForm.houseOwner" placeholder="请输入联系人" clearable style="width: 200px" />
                    </Form-item>
...
<script>
import {
    getHouseLeaseOrderList,
    deleteHouseLeaseOrder,
    pay
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getHouseLeaseOrderList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
