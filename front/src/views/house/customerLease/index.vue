            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="houseType">
                        <Select v-model="searchForm.houseType" placeholder="请选择" clearable style="width: 200px">
                            <Option value="0">下拉框值A</Option>
                            <Option value="0">下拉框值B</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="address">
                        <Input type="text" v-model="searchForm.address" placeholder="请输入地址" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="请输入买家姓名" clearable style="width: 200px" />
                    </Form-item>
...
<script>
import {
    getCustomerLeaseList,
    deleteCustomerLease,
    passCustomerLease,
    notPassCustomerLease
} from "./api.js";
...
export default {
                        ...
                        return h("div", [
                            h(
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            this.passCustomerLeaseFx(params.row);
                                        }
                                    }
                                },
                                "同意"
                            ...
                            h(
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            this.notPassCustomerLeaseFx(params.row);
                                        }
                                    }
                                },
                                "驳回"
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCustomerLeaseList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
