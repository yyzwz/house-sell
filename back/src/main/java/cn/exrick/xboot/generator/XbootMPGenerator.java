...
public class XbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String CLASS_NAME = "VillageStyle";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String DESCRIPTION = "一村一品";
     ...
     * (文件自动生成至该包下)
     */
    private static final String ENTITY_PACKAGE = "cn.exrick.xboot.modules.bm.entity";

    /**
     * dao对应包 【注意修改后需到cn.exrick.xboot.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "cn.exrick.xboot.modules.bm.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_PACKAGE = "cn.exrick.xboot.modules.bm.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_IMPL_PACKAGE = "cn.exrick.xboot.modules.bm.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String CONTROLLER_PACKAGE = "cn.exrick.xboot.modules.bm.controller";

    /**
     * 路径前缀
     */
    private static final String SYS_PATH = System.getProperty("user.dir") + "/src/main/java/";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException {
        ...
        // 创建文件
        String mapperXmlFileUrl = System.getProperty("user.dir") + "/src/main/resources/mapper/" + name(CLASS_NAME, true) + "Mapper.xml";
    ...
    private static void deleteCode(String className) {
        ...
        String mapperXmlFileUrl = System.getProperty("user.dir") + "/src/main/resources/mapper/" + name(className, true) + "Mapper.xml";
